...
- Name the new column `JSON` and hit `OK`. It might take a minute or so to load but eventually we should get a new column called `JSON` with a paragraph of text in JSON format. 
